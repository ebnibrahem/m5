...
<aside>
	...
	<div class="panel panel-default center">
		...
		<div class="panel-body _20">
			...
			<a href="<?=url('admin?do=logout')?>" class="f_red" data-toggle="tooltip" data-placement="top" title="<?= str('logout')?>"><i class="fa fa-power-off"></i></a>
		</div>

		<div>
			?php if ($data['alert_admin']): ?>
...
<ul class="list-group ">
	...
	<li class="list-group-item br"><a href="<?=url('admin/pages')?>"> <i class="fa fa-database small f_base"></i> <?= string('pages'); ?> </a></li>
	...
	<?php if( Auth::valid($roles,[4],'dontshowecho') == "200") :?>
		<li class="list-group-item "><a href="<?=url('admin/reports')?>"> <i class="fa fa-pie-chart small f_base"></i> <?= string('reports') ;?> </a></li>

		<li class="list-group-item br"><a href="<?=url('admin/statistic')?>"> <i class="fa fa-bar-chart small f_base"></i> <?= string('statistic') ;?> </a></li>

		<li class="list-group-item"><a href="<?=url('admin/root')?>"> <i class="fa fa-lock small f_base"></i> <?= str('administration') ?> </a> </li>

		<li class="list-group-item"><a href="<?=url('admin/setting')?>"> <i class="fa fa-gear small f_base"></i> <?= str('setting') ?> </a> </li>

		<li class="list-group-item">
			<a style="float: <?= TEXT_DIRECTION_END?>;" href="<?=url('admin/backup/do/add')?>"> <i class="fa fa-save small f_base" data-toggle="tooltip" data-placement="top" title="<?=s('add_new')?>" ></i></a>
			<a href="<?=url('admin/backup')?>"><i class="fa fa-database small f_base"></i> <?= str('backup') ?> </a> </li>
		<?php endif;?>
		...
		<li class="list-group-item">
			...
			<a href="<?=url('admin/files')?>"> <i class="fa fa-folder small f_base"></i> <?= string('library') ?> </a>
		</li>
